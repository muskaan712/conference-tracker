...
export const metadata: Metadata = {
  ...
  description:
    "What data this tracker stores, where it lives, and what an account does and doesn't give you.",
    ...
    <div className="max-w-2xl space-y-8">
      ...
      <section className="space-y-3">
        ...
        <p className="text-foreground/90 text-sm">
          ...
          this project&apos;s source code. Nothing about them is personal — anyone who visits the
          site sees the same data, and browsing it isn&apos;t tracked against you individually.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-foreground/90 text-sm">
          ...
          cross-device sync for the same data guest mode already offers — nothing more. When signed
          in, your papers, saved plans, favourites, and a couple of small preferences are stored in
          Cloud Firestore under a document keyed to your Firebase user ID (
          <code>users/&#123;uid&#125;/...</code>), readable only by that account.
        </p>
        <p className="text-foreground/90 text-sm">
          What&apos;s stored is metadata you type in yourself — paper titles, target conferences,
          stages, notes, and similar — never manuscript files or attachments; this tracker has no
          file upload feature.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-foreground/90 text-sm">
          Traffic between your browser and Firebase/Google&apos;s servers is encrypted in transit
          (HTTPS), and Google encrypts stored data at rest on its infrastructure. This application
          does not implement its own end-to-end encryption — Firebase (and, by extension, Google)
          can access the data it stores in the ordinary course of operating the service, the same as
          any standard cloud database.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <ul className="text-foreground/90 list-inside list-disc space-y-1 text-sm">
          <li>
            ...
            account (papers, saved plans, favourites, preferences) as a single JSON file at any
            time.
          </li>
          <li>
          ...
          <li>
            ...
            <span>
              ...
              guarantee that no data remains anywhere in Firebase&apos;s infrastructure (e.g.
              backups or logs Google itself retains).
            </span>
          </li>
        </ul>
      </section>
